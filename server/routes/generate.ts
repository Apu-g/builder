...
// ============================================================
// Build curated image map (replaces images.ts import)
// ============================================================
function buildCuratedImageMap(
  niche: string,
  _description: string,
  _sectionKeys: string[],
  _imageQueries: Record<string, unknown>
...
// ============================================================
// Deep merge helper (for edit-site)
// ============================================================
...
// ============================================================
// POST /generate-site-v2 — 3-Provider Pipeline
// ============================================================
generateRouter.post('/generate-site-v2', async (req: Request, res: Response) => {
  try {
    ...
    try {
      ...
      imageMap = buildCuratedImageMap(niche, description, templateDef.metadata.sections, imageQueries);
    } catch (err) {
      console.error('[v2] OpenRouter images failed:', (err as Error).message);
      imageMap = buildCuratedImageMap(niche, description, templateDef.metadata.sections, {});
    }
...
// ============================================================
// POST /generate-site — v1 NIM fallback
// ============================================================
